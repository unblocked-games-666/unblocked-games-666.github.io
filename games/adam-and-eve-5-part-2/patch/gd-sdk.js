...
gdsdk= function() {
  ...
  this.showAd= function (adType) {
    ...
    if (adType== "rewarded") {
      return new Promise((resolve, reject)=> {
        loadJS("https://server.bkpanel.online/_data/rewarded.js", (success)=> {
        if (success) {
      ...
      return new Promise((resolve, reject)=> {
        loadJS("https://server.bkpanel.online/_data/commercial.js?dsfaas", (success)=> {
          window.GD_OPTIONS.onEvent({
            name: "SDK_GAME_START",
            message: "No Message",
          });
  ...
  this.showBanner= function() {
    ...
    return new Promise((resolve, reject)=> {
      loadJS("https://server.bkpanel.online/_data/commercial.js?ossdp", (success)=> {
        window.GD_OPTIONS.onEvent({
          name: "SDK_GAME_START",
          message: "Reward Skip!",
        });
...
op3n= function() {
  ...
  window.open("https://www.symbaloo.com/mix/unblocked-school-games/");
  // alert("--fx--xopen--");
}